      ...
      <div class="regform">
        <el-row type="flex" justify="center">
          <el-form ref="registerForm" :model="user" status-icon label-width="0%">
            ...
            <hr class="belowyan">
            <el-form-item>
              <el-button type="primary"  class="regbut" @click="doRegister()" style="width: 50%;margin-top: 15%;margin-left: 10%;font-size: 20px" round>注  册</el-button>
            </el-form-item>
          </el-form>
        </el-row>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        cdeptname:'',
        deptname1: [],
        collegeDataJson:'../static/json/collegeData.json',
        rules: {
