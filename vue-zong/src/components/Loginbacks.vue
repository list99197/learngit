        ...
        <el-row type="flex" justify="center">
          <el-form ref="loginForm" :model="user" status-icon label-width="0%">
            ...
            <el-form-item prop="code" label="">
              <el-input v-model="user.code"  placeholder="验证码" class="code-in" style="width: 80%;margin-left: -58%" clearable><i slot="prefix" class="fontReg regyanzhengma"></i></el-input>
            </el-form-item>

            <img id="u15" src="/api/validateCode"  @click="getCodeImg()" height="61px" width="168px">
            <hr class="belowyan">
            <el-form-item>
              <el-button type="primary"  class="logbut" @click="doLogin()" style="width: 65%;margin-top: 15.8%;margin-left: -73.5%;font-size: 20px" round>登  录</el-button>
            </el-form-item>

            <el-form-item>
              <el-button type="primary"  class="regbut" @click="goRegister()" style="width: 65%;margin-top: -26.5%;margin-left: 7%;font-size: 20px;position: absolute" round>未  注  册？</el-button>
            </el-form-item>
